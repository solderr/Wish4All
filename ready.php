...
<html>
<head>
<!---This Script Edited and Designed By Dilip Solanki------->
...
<ins class="adsbygoogle"
     ...
     data-ad-client="ca-pub-4182278384929661"
     data-ad-slot="9310503061"></ins>
<script>
...
<script>
    createjs.Sound.registerSound("tweaker.mp3", "");
    setTimeout(function () {
        createjs.Sound.play("");
    }, 3000)
</script>
<!--- Mp3 Auto Player--->
<iframe width="0%" height="0" scrolling="no" frameborder="no" allow="autoplay" src="https://www.saavn.com/s/song/marathi/Namo-Ganesha/O-My-Friend-Ganesha-Rap/SQ05CEB1AHQ"></iframe>
...
<!--- Header AdSense code Here (300x60 Display ads)---> 
   ...
   <script type="text/javascript">
    google_ad_client = "ca-pub-4182278384929661";
    google_ad_slot = "9310503061";
    google_ad_width = 300;
    google_ad_height = 60;
</script>
<!-- Wish4All -->
...
<a class="footerbtn" href="whatsapp://send?text= मुझसे पहले ऐसा संदेश आपके लिए किसी ने नही भेजा होगा निचे क्लिक करके देखो क्या है आपके लिए 👇 👇 %0A Yourwebsite.Com/?n=<?php echo $name; ?> %0A"><img width="25px" height="25px" src="wp.png"/><b style="font-size: 15px;"> Click Here to Share on Whatsapp</b> <img width="25px" height="25px" src="wp.png"/>
</a></div>
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-125061366-1
"></script>
